...
import * as migration_20260620_110000_add_announcement_de from './20260620_110000_add_announcement_de';
import * as migration_20260620_120000_add_pro_member_phone from './20260620_120000_add_pro_member_phone';
import * as migration_20260715_150000_add_subscription_collections from './20260715_150000_add_subscription_collections';
...
import * as migration_20260615_120000_uppercase_promo_codes from './20260615_120000_uppercase_promo_codes';
...
import * as migration_20260805_100000_add_products_seo_fields from './20260805_100000_add_products_seo_fields';
import * as migration_20260824_100000_add_order_payment_fields from './20260824_100000_add_order_payment_fields';
import * as migration_20260912_120000_add_affiliate_attribution from './20260912_120000_add_affiliate_attribution';
...
export const migrations = [
  ...
  {
    up: migration_20260615_120000_uppercase_promo_codes.up,
    down: migration_20260615_120000_uppercase_promo_codes.down,
    name: '20260615_120000_uppercase_promo_codes',
  },
  {
    up: migration_20260617_100000_add_reseller_fields.up,
    down: migration_20260617_100000_add_reseller_fields.down,
    name: '20260617_100000_add_reseller_fields',
  },
  {
    up: migration_20260618_100000_add_reseller_description.up,
    down: migration_20260618_100000_add_reseller_description.down,
    name: '20260618_100000_add_reseller_description',
  },
  {
    up: migration_20260619_090000_add_kit_section.up,
    down: migration_20260619_090000_add_kit_section.down,
    name: '20260619_090000_add_kit_section',
  },
  {
  ...
  {
    up: migration_20260620_110000_add_announcement_de.up,
    down: migration_20260620_110000_add_announcement_de.down,
    name: '20260620_110000_add_announcement_de',
  },
  {
    up: migration_20260620_120000_add_pro_member_phone.up,
    down: migration_20260620_120000_add_pro_member_phone.down,
    name: '20260620_120000_add_pro_member_phone',
  },
  {
    up: migration_20260715_150000_add_subscription_collections.up,
    down: migration_20260715_150000_add_subscription_collections.down,
    name: '20260715_150000_add_subscription_collections',
  },
  {
    up: migration_20260716_120000_add_printful_fields.up,
    down: migration_20260716_120000_add_printful_fields.down,
    name: '20260716_120000_add_printful_fields',
  },
  {
  ...
  {
    up: migration_20260805_100000_add_products_seo_fields.up,
    down: migration_20260805_100000_add_products_seo_fields.down,
    name: '20260805_100000_add_products_seo_fields',
  },
  {
    up: migration_20260824_100000_add_order_payment_fields.up,
    down: migration_20260824_100000_add_order_payment_fields.down,
    name: '20260824_100000_add_order_payment_fields',
  },
  {
    up: migration_20260912_120000_add_affiliate_attribution.up,
    down: migration_20260912_120000_add_affiliate_attribution.down,
    name: '20260912_120000_add_affiliate_attribution',
  },
];
