 ...
 * - Spring damping per movimento fluido (no jitter).
 */
export function InkThread() {
  ...
  // Goccia: fade-in dopo i primi pixel di scroll (evita pop iniziale)
  const dropOpacity = useTransform(smooth, [0, 0.015], [0, 1])

  // Pulse organico: piccola variazione scale loop (la goccia "respira")
  return (
    <div
    ...
    >
      ...
      >
        ...
        {/* Highlight specularе — riflesso luce */}
        <div
