...
export const metadata = { title: 'Ordine confermato — The Foolish Butcher' }

export default function GraziePage() {
  return (
    <div className="max-w-xl mx-auto px-4 py-24 text-center">
      <div className="text-5xl mb-6">✓</div>
      <h1 className="text-2xl font-bold mb-3">Ordine ricevuto.</h1>
      <p className="mb-6" style={{ color: 'var(--muted-fg)' }}>
        Ho ricevuto il tuo ordine. Riceverai una conferma via email.<br />
        Ti scrivo personalmente quando i tuoi fogli sono pronti.
      </p>

      {/* CTA Telegram */}
      <div className="rounded-lg p-5 mb-8 border" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--muted)' }}>
        <p className="font-medium mb-2">Ricevi aggiornamenti diretti su Telegram</p>
        <p className="text-sm mb-4" style={{ color: 'var(--muted-fg)' }}>
          Ti avviso quando i fogli sono pronti, ti mando le foto di quello che stai per ricevere,
          e ti mando il tracking non appena spedito.
        </p>
        <a
          href={`https://t.me/${process.env.NEXT_PUBLIC_TELEGRAM_BOT_USERNAME || 'foolishbutcherbot'}?start=neworder`}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded font-semibold text-sm transition-colors"
