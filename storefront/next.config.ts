...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [
      ...
      {
        // The affiliate stats page carries its access token in the query string:
        // keep it out of search indexes, shared caches, and Referer leakage.
        source: '/:locale/a/:slug/stats',
        headers: [
